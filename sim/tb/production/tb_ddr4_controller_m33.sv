...
module tb_ddr4_controller_m33;
  ...
  reg init_start=1;wire init_done;reg[16:0]mr[0:6];ddr_req_t wr_req_data,rd_req_data;reg wr_empty=1,rd_empty=1;wire wr_rd,rd_rd;wire ddr_rsp_t rsp_data;wire rsp_wr;reg rsp_full=0;
  ...
  initial begin
    ...
    // {row[30:16],bg[15:14],bank[13:12],col[11:2],byte[1:0]}
